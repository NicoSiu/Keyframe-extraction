...
person_weights="C:\\Users\\lixin\\PycharmProjects\\yolov7\\yolov7.pt"
...
source_folder = "C:\\Users\\lixin\\fighting dataset\\photo\\fighting_photo"
destination_folder = "C:\\Users\\lixin\\fighting dataset\\photo\\fighting_photo_new"
...
for filename in os.listdir(source_folder):
    ...
    # Path to output
    target_folder = os.path.join(destination_folder, photo_name)
    ...
    print("New photo reading starts!")
    ...
    # -------Person detection-------
    results_person = model_person(image)
